...
class Vgg19:
    ...
    def __init__(self, vgg19_npy_path=None, trainable=True, dropout=0.5):
        ...
        self.resuem = not self.trainable
        self.dropout = dropout

    def build(self, rgb, train_mode=False, resume=True):
        """
        ...
        self.trainable = train_mode and False
        ...
        self.fc7_1 = self.fc_layer(self.fc6, 4096, 12544, "fc7_1") #12544 = 256*7*7
        self.tn5_7_1 = self.conv_layer(self.pool5, 3, 512, 256, "tn5_7_1")
        self.tn5_7_2 = self.conv_layer(self.tn5_7_1, 3, 256, 256, "tn5_7_2")
        self.conv7_1 = self.concat(tf.reshape(self.fc7_1, [tf.shape(self.pool5)[0],7,7,256]), self.tn5_7_2, "conv7_1")
        self.upool7 = self.un_pool(self.conv7_1, "upool7")        
        self.conv7_2 = self.conv_layer(self.upool7, 3, 512, 256, "conv7_2")

        self.tn4_8_1 = self.conv_layer(self.pool4, 3, 512, 256, "tn4_8_1")
        self.tn4_8_2 = self.conv_layer(self.tn4_8_1, 3, 256, 256, "tn4_8_2")
        self.conv8_1 = self.concat(self.conv7_2, self.tn4_8_2, "conv8_1")
        self.upool8 = self.un_pool(self.conv8_1, "upool8")
        self.conv8_2 = self.conv_layer(self.upool8, 3, 512, 128, "conv8_2")

        self.tn3_9_1 = self.conv_layer(self.pool3, 3, 256, 128, "tn3_9_1")
        self.tn3_9_2 = self.conv_layer(self.tn3_9_1, 3, 128, 128, "tn3_9_2")
        self.conv9_1 = self.concat(self.conv8_2, self.tn3_9_2, "conv9_1")
        self.upool9 = self.un_pool(self.conv9_1, "upool9")
        self.conv9_2  = self.conv_layer(self.upool9, 3, 256, 64, "conv9_2")

        self.tn2_10_1 = self.conv_layer(self.pool2, 5, 128, 64, "tn2_10_1")
        self.tn2_10_2 = self.conv_layer(self.tn2_10_1, 5, 64, 64, "tn2_10_2")
        self.conv10_1 = self.concat(self.conv9_2, self.tn2_10_2, "conv10_1")
        self.upool10 = self.un_pool(self.conv10_1, "upool10")
        self.conv10_2 = self.conv_layer(self.upool10, 3, 128, 32, "conv10_2")

        self.tn1_11_1 = self.conv_layer(self.pool1, 5, 64, 32, "tn1_11_1")
        self.tn1_11_2 = self.conv_layer(self.tn1_11_1, 5, 32, 32, "tn1_11_2")
        self.conv11_1 = self.concat(self.conv10_2, self.tn1_11_2, "conv11_1")
    ...
    def get_var(self, initial_value, name, idx, var_name):
        if self.data_dict is not None and name in self.data_dict and self.resume:
